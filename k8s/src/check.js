...
let eng = "";
for(const f of ["30_yaml.js","31_model.js","32_ctrl.js","33_kubectl.js","34_ops.js","35_run.js"])
...
eval(eng + "\n" + content + "\nfor(const n of [\"MODULES\",\"runKubectl\",\"newScenario\",\"seed\",\"list\",\"get\",\"podReady\",\"podPhase\",\"qosOf\",\"cpuOf\",\"memOf\"]) globalThis[n] = eval(n);");
