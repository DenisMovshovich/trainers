...
labs:[
 {id:"4a", title:"Первый Dockerfile",
  ...
  setup(st){ st.files["/work/index.html"]="<html><body><h1>Docker Yard</h1><p>Собрано своими руками.</p></body></html>"; },
  checks:[
   ...
   {label:"Отдаётся ваш HTML, а не страница nginx по умолчанию", test:st=>{const c=C(st,"site"); if(!c)return false; const v=cRead(st,c,"/usr/share/nginx/html/index.html"); return v!==undefined && /Docker Yard/.test(String(v));}}
  ]},
